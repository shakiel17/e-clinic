...
<head>
  ...
  <title>e-Clinic | MedMatrix e-Health Solutions</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Account Registration</h5>
                    <p class="text-center small">Please fill all fields.</p>
                  </div>

                  <form class="row g-3 needs-validation" novalidate action="<?=base_url();?>registration" method="POST">
                    ...
                    <div class="col-12">
                      <label for="yourPAN" class="form-label">PHIC Accreditation No.</label>
                      <input type="text" name="phicacc" class="form-control" id="yourPAN" required placeholder="xxxx-xxxxxxxx-x">
                      <div class="invalid-feedback">Please enter your PHIC Accreditation Number!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already registered? <a href="<?=base_url();?>">Login</a></p>
                    </div>
                  </form>
