          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              if($item['status']=="Active"){
                ?>
              <a href="" class="btn btn-danger btn-sm"><i class="bi bi-box-arrow-in-up"></i> Discharge</a>
              <?php
              }
              ?>
            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?=$item['remarks'];?></td>
                                    <td><a href="" class="btn btn-info btn-sm" title="Print"><i class="bi bi-printer"></i></a> <a href="" class="btn btn-danger btn-sm" title="Delete"><i class="bi bi-trash"></i></a></td>
                                </tr>
                                <?php
                                }
                                ?>
