          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="<?=base_url();?>submitadmission">
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    <input type="date" class="form-control" id="floatingEmail" placeholder="Your Email" required>
                ...
                <div class="col-md-4">
                  <div class="col-md-12">
                    <div class="form-floating">
                      <input type="text" class="form-control" id="floatingCity" placeholder="City" name="nationality">
                      <label for="floatingCity">Nationality</label>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
