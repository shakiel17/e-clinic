            ...
            <div class="card-body">
              <table width="100%" border="0">
                  <tr>
                    ...
                    <td align="right"><a type="submit" data-bs-toggle="modal" data-bs-target="#addDoctorModal" class="btn btn-primary btn-sm rounded-pill"><i class="bi bi-plus-circle"></i> New Doctor</td></td>
                  </tr>
              </table>              
